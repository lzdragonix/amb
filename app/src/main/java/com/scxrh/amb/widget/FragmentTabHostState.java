...
public class FragmentTabHostState extends TabHost implements TabHost.OnTabChangeListener
{
    ...
    public FragmentTabHostState(Context context)
    {
    ...
    public FragmentTabHostState(Context context, AttributeSet attrs)
    {
        super(context, attrs);
